...
public class ConfigurationDialog extends JDialog implements Serializable{
	/**
	 * 
	 */
	private static final long serialVersionUID = 3037581322009010899L;
	...
	private JPanel createGamePanel(final TableFrame table) {		
		...
		cb = BorderFactory.createCompoundBorder(cb,
